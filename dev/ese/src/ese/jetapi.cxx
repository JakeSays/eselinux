...
TermAlloc:
    ...
    if ( err < JET_errSuccess && err != JET_errRecoveredWithoutUndo )
    {
        ...
        PERSISTED // for optics "Verbose: 1", "FI Tags Published: 0x", and "FiCorruptionTag ".  see Exch \ EseEventCategorized.cs, Exch \ EseDatabaseMonitoringContext.cs
        (void)ErrOSStrCbFormatW( wszHaPublishingFacts, sizeof( wszHaPublishingFacts ), L"Verbose: %d, FI Tags Published: 0x%x ( %hs%hs)", 
