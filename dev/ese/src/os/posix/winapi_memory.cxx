...
{
    void* const p = ( uFlags & LMEM_ZEROINIT ) ? calloc( 1, uBytes ) : malloc( uBytes );
                                 ...
                                 PVOID* BackTrace, PDWORD BackTraceHash )
{
    ...
    const DWORD cap  = ( want > c_maxFrames ) ? c_maxFrames : want;
    ...
    const DWORD emit     = ( captured > FramesToCapture ) ? FramesToCapture : captured;
